...
public class UpdateRoleServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		BeanRole dt = rs.updateRoleById(id);
		request.setAttribute("role",dt);
		request.getRequestDispatcher("/WEB-INF/role/updateRole.jsp").forward(request, response);
	}
