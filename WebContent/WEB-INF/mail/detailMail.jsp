...
<body>
	<div class="box">
		<h3>邮件详情</h3>
		<form action="detailMail" method="post">
			<table class="form-table">
				<tr>
					<td class="label">发件人</td>
					<td class="detail">${ mail.sendName }</td>
				</tr>
				<tr>
					<td class="label">收件人</td>
					<td colspan="3" class="detail">${ mail.receiveName }</td>
				</tr>
				<tr>
					<td class="label">邮件主题</td>
					<td colspan="3" class="detail">${ mail.m_theme }</td>
				</tr>
				<tr>
					<td class="label">邮件内容</td>
					<td colspan="3" class="detail">${ mail.m_content }</td>
				</tr>
				<tr>
